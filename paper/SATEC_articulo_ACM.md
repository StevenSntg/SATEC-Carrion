...
**Figura 5.** Precisión, sensibilidad, F1 y especificidad por modelo (validación temporal estricta). La especificidad es alta en todos; la red neuronal equilibra mejor sensibilidad y precisión. Fuente: elaboración propia con SATEC [22].
